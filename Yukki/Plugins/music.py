...
async def play(_, message: Message):
    ...
    if audio:
        fucksemx = 1
        mystic = await message.reply_text("**🔄 ꜱᴇᴅᴀɴɢ ʟᴏᴀᴅɪɴɢ...**")
