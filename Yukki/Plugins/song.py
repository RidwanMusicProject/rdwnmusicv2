...
async def musicdl(_, message: Message):
    ...
    if url:
        ...
        mystic = await _.send_message(chat_id, "🔍 **ᴍᴇɴɢᴜɴᴅᴜʜ ɢʙʟᴏᴋ...**")
        ...
        m = await message.reply_photo(
            ...
            caption=(f"🏷 <b>Name:</b> [{title[:65]}]({url})\n\n💡 [HALBERT](https://t.me/rdwan_13?start=info_{id})")
        )   
        os.remove(thumb)
    else:
...
async def chonga(_,CallbackQuery): 
    ...
    if i == 1:
        ...
        await CallbackQuery.edit_message_text(
            f"6️⃣ <b>[{title6[:25]}...]({link})</b>\n ├ 💡 [HALBERT](https://t.me/rdwan_13?start=info_{ID6})\n └ ⚡ __Powered by Ridwan Music AI__\n\n7️⃣ <b>[{title7[:25]}...]({link})</b>\n ├ 💡 [HALBERT](https://t.me/rdwan_13?start=info_{ID7})\n └ ⚡ __Powered by Ridwan Music AI__\n\n8️⃣ <b>[{title8[:25]}...]({link})</b>\n ├ 💡 [HALBERT](https://t.me/rdwan_13?start=info_{ID8})\n └ ⚡ __Powered by Ridwan Music AI__\n\n9️⃣ <b>[{title9[:25]}...]({link})</b>\n ├ 💡 [HALBERT](https://t.me/rdwan_13?start=info_{ID9})\n └ ⚡ __Powered by Ridwan Music AI__\n\n🔟 <b>[{title10[:25]}...]({link})</b>\n ├ 💡 [HALBERT](https://t.me/rdwan_13?start=info_{ID10})\n └ ⚡ __Powered by Ridwan Music AI__",    
            reply_markup=InlineKeyboardMarkup(buttons),
        )  
        disable_web_page_preview=True
        return    
